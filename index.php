...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div id="wrapper">
			<div id="header">
				<div id="logo">
					<h1><a href="http://iloreto.me">iLoreto.me</a></h1>
				</div>
				<!--	<div id="menu">
				<ul>
				<li><a href="#" accesskey="1" title="">Home</a></li>
				<li><a href="#" accesskey="2" title="">Work</a></li>
				<li><a href="#" accesskey="3" title="">Hobbies</a></li>
			...
			<div id="footer">
				<p>
					Copyright &copy; <?php echo date("Y"); ?> <a href='mailto:iloreto.me@gmail.com'>iLoreto.me</a> All rights reserved.
